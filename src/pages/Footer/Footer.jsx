        ...
        <div className='place-content-center'>
            ...
            <footer className="p-4 bg-slate-100 sm:p-6 dark:bg-gray-900">
                <div className="flex flex-col justify-center items-center md:justify-evenly md:flex-row">
                    <div className="mb-6 md:mb-0">
                        <Link to='/' className="flex items-center lg:item:start justify-center w-fit mx-auto h-fitr">
                            <p className='text-2xl font-extrabold text-amber-300 '>Schedule</p>
                            <img src={logo} className="w-[200px]" alt="Logo" />
                            <p className='text-2xl font-extrabold text-amber-300'>Your Plan</p>
                        </Link>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://github.com/Shihab-Sabbir" target="_blank" className="hover:underline">SRS PRODUCTION™</a>. All Rights Reserved.
                    </span>
